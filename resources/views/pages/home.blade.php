    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div class="text-center lg:text-left">
                <div class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-emerald-500/20 text-emerald-300 mb-6 border border-emerald-500/30">
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    ...
                    <a href="{{ route('how-it-works') }}" class="inline-flex items-center justify-center px-8 py-3 border border-emerald-400 text-base font-medium rounded-lg text-emerald-100 hover:bg-emerald-800/50 transition-colors">
                        Comment ca marche ?
                    </a>
                </div>
            </div>
            ...
            <div class="mt-12 lg:mt-0 flex justify-center">
                <div class="relative">
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="h-48 w-48 rounded-full bg-emerald-400/20 animate-ping" style="animation-duration: 3s;"></div>
                    </div>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="h-40 w-40 rounded-full bg-emerald-400/10 animate-ping" style="animation-duration: 3s; animation-delay: 0.5s;"></div>
                    </div>
                    <div class="relative z-10 bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-emerald-400/20">
                        <svg class="h-32 w-32 text-emerald-400 animate-float" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
            @php
            $steps = [
                ['num' => '1', 'title' => 'Inscription', 'desc' => 'Creez votre compte avec KYC legere', 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'],
                ['num' => '2', 'title' => 'Creation', 'desc' => 'Le vendeur enregistre la vente', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'],
                ['num' => '3', 'title' => 'Paiement', 'desc' => 'Fonds bloques en sequestre', 'icon' => 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z'],
                ['num' => '4', 'title' => 'Livraison', 'desc' => 'Le vendeur expedie, vous inspectez', 'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4'],
                ['num' => '5', 'title' => 'Liberation', 'desc' => 'Confirmation = fonds transferes', 'icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
            ];
            @endphp

            @foreach($steps as $step)
            <div class="relative bg-gray-50 rounded-xl p-6 text-center border border-gray-100 hover:border-emerald-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div class="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <span class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-emerald-600 text-white text-sm font-bold shadow-md">{{ $step['num'] }}</span>
                </div>
                <div class="mt-4">
                    <svg class="h-10 w-10 text-emerald-500 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-10 text-center">
            <a href="{{ route('how-it-works') }}" class="inline-flex items-center text-emerald-600 font-medium hover:text-emerald-700 transition-colors">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
                ...
                <p class="text-gray-500">L'argent est bloque en sequestre. Le vendeur ne touche rien sans livrer. L'acheteur ne recoit rien sans payer.</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
                ...
                <p class="text-gray-500">Commission transparente de 3% par transaction. Pas de frais caches, pas d'abonnement obligatoire.</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
                ...
                <p class="text-gray-500">Paiement via TMoney et Moov Money. Aucun compte bancaire requis. Simple, rapide, local.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-emerald-700">
    <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
        <div>
            ...
            <p class="mt-3 text-lg text-emerald-200">Rejoignez PayXora et faites partie de la revolution du e-commerce securise au Togo.</p>
        </div>
